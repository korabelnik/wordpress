 ...
 */
return array(
	'title'      => __( 'Unibiz Page Core Hero', 'unibiz' ),
...
<div class="wp-block-group"><!-- wp:post-title {"textAlign":"center","className":"unibiz-h2-alt-2","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|gv-color-text-primary"}}}},"textColor":"gv-color-text-primary","fontSize":"jumbo","fontFamily":"host-grotesk"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->',
	'is_sync' => false,
);
